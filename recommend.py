...
def get_products_dataframe(posts, model):
    ...
    Each post should include at least an identifier, an 'embedding', and optionally a 'description'.
    """
    data = []
    for post in posts:
        try:
            ...
            # Now take the embedding directly from the post.
            ...
            if embedding is None:
                # Fallback if no embedding is provided (should not happen ideally)
